...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h2 mb-0">Измени производ</h1>
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description" id="description" rows="8" required
                                class="form-control tinymce-editor @error('description') is-invalid @enderror">{{ old('description', $product->description) }}</textarea>
                            @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
