...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h2 mb-0">Измени категорију</h1>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Измени</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-body">
            <form action="{{ route('editor.categories.update', $category) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="mb-4">
                    ...
                    <textarea name="description" id="description" rows="8"
                        class="form-control tinymce-editor @error('description') is-invalid @enderror">{{ old('description', $category->description) }}</textarea>
                    @error('description')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="d-flex justify-content-end gap-2">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save me-2"></i>Сачувај измене
                    </button>
                </div>
            </form>
        </div>
